...
# This allows the script to work when called from different directories
vggt_dir = Path(__file__).parent
vggt_dir_str = str(vggt_dir)
if vggt_dir_str not in sys.path:
    sys.path.insert(0, vggt_dir_str)
...
def demo_fn(args):
    ...
    checkpoint_path = os.path.join(vggt_dir, "checkpoints/vggt.safetensors")
...
Output:
    ...
    │   └── 0/            # COLMAP reconstruction directory (required by 3DGS)
